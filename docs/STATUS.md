...
- 408 backend tests at 90% line coverage, plus 96 frontend tests.
...
administration, and the dashboard itself — the intelligence API is complete
and exercised, but nothing renders it.
